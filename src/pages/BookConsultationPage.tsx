...
export function BookCompletePage() {
    ...
    return (
      <div className="min-h-screen bg-[var(--page-cream)] text-[#1a1a1a] px-[var(--page-gutter)] py-24">
        <div className="max-w-lg mx-auto">
          <h1 className="font-serif text-4xl font-semibold tracking-tight">Checkout did not finish.</h1>
          <p className="mt-3 text-slate-600">You can return to the calendar and try again when you are ready.</p>
          <Link to="/book" className="mt-8 inline-flex rounded-full bg-black text-white px-5 py-2.5 text-sm font-semibold">
            Back to booking
          </Link>
        </div>
      </div>
  ...
  return (
    <div className="min-h-screen bg-[var(--page-cream)] text-[#1a1a1a] px-[var(--page-gutter)] py-24">
      <div className="max-w-lg mx-auto">
        <p className="text-xs font-semibold uppercase tracking-[0.16em] text-slate-500">Payment received</p>
        <h1 className="mt-2 font-serif text-4xl sm:text-5xl font-semibold tracking-tight leading-snug">
          Create your <span className="italic text-slate-500">portal account.</span>
        </h1>
        <p className="mt-4 text-slate-600 leading-relaxed">
          Your consultation request is in. Register with the same email
          {email ? (
            <>
              {" "}
