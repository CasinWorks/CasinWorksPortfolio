        ...
        <div className="flex flex-wrap gap-3">
          {study.liveLinks.map((link) => (
            <a
              ...
              className="inline-flex items-center gap-2 rounded-full border border-slate-600 bg-white/5 px-4 py-2 text-[10px] font-black uppercase tracking-[0.3em] text-slate-200 hover:border-white hover:text-white transition-colors"
            >
              {link.label}
